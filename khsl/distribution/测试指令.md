...
本文档记录了在 OpenHarmony (RK3568) 上验证 KHSL 核心功能（微内核隔离、资源限制、多用户管理、TTY 交互、WSL CLI 兼容）的完整步骤。
...
在宿主机（OpenHarmony）的 shell 中执行，验证与 WSL 命令行风格的对齐：
